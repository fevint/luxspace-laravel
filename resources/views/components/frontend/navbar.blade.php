<!-- START: HEADER -->
<header class="{{\Route::current()->getName() == ['index'] ? 'absolut' : ''}} w-full z-50 px-4">
    <div class="container mx-auto py-5">
        <div class="flex flex-stretch items-center">
            <div class="w-56 items-center flex">
                <a href="{{route('index')}}">
                    <img src="/frontend/images/content/logo.png" alt="Luxspace | Fulfill your house with beautiful furniture" /></a>
            </div>
